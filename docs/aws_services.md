...
| Artifact | Security, Identity and Compliance | On-demand access to AWS’ compliance reports |
...
| Certificate Manager | Security, Identity and Compliance | Provision, manage, and deploy SSL/TLS certificates |
...
| CloudHSM | Security, Identity and Compliance | Hardware-based key storage for regulatory compliance |
...
| Detective | Security, Identity and Compliance | Investigate potential security issues |
...
| GuardDuty | Security, Identity and Compliance | Managed threat detection service |
...
| Inspector | Security, Identity and Compliance | Automate vulnerability management |
| Key Service Management (KSM) | Security, Identity and Compliance | Managed creation and control of encryption keys |
...
| Shield | Security, Identity and Compliance | DDoS protection |
